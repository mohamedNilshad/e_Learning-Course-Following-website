...
<div class="container" id="container">
	<div class="form-container sign-in-container">
		<form action="{{route('admin-update-new-password')}}" method="post">
			@csrf
			@method('PUT')

			<br>
			<a href="{{'forgotPassword'}}" style="text-align: start; padding-bottom: 15px;"><i class="fa fa-arrow-left" aria-hidden="true" ></i></a>
             <h5>Password Reset</h5>
			<label style="text-align: start; font-size: 12px; color: black; font-weight: 550;"> Enter your New Password: </label>
