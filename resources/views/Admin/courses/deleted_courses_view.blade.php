...
@section('title', 'Deleted Course View')

@section('content')
    <br>
    <h2>Deleted Course View</h2>
    ...
    <div class="edit-button">
        ...
        <a href="{{ route('reject-course') }}?cid={{ $course->id }}&status={{ $course->publishCourse}}&delete={{ $course->deleteCourse}}" class="btn btn-danger">Reject</a>
    </div>
